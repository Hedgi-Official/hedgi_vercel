              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Invista, viaje e gaste sem estresse, sabendo que sua moeda está protegida da volatilidade do mercado.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="relative rounded-xl overflow-hidden aspect-square">
                    <img
                      ...
                      alt="Clientes felizes usando Hedgi"
                  ...
                  <div className="relative rounded-xl overflow-hidden aspect-square">
                    <img
                      ...
                      alt="Profissional usando proteção cambial"
                      className="w-full h-full object-cover"
                      loading="lazy"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                  ...
                  <div className="relative rounded-xl overflow-hidden aspect-square">
                    <img
                      ...
                      alt="Família garantindo seu futuro financeiro"
                      className="w-full h-full object-cover"
                      loading="lazy"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                  ...
                  <div className="relative rounded-xl overflow-hidden aspect-square">
                    <img
                      ...
                      alt="Investidor experiente com tranquilidade"
                      className="w-full h-full object-cover"
                      loading="lazy"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
