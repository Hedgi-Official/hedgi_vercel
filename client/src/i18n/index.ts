...
const enUS = {
  translation: {
    ...
    simulator: {
      ...
      expirationDateHelp: 'Select the date when your hedge will expire. You can choose any date from 3 days to 1 year in the future. The hedge will automatically close on this date.',
      days: 'days',
...
const ptBR = {
  translation: {
    ...
    simulator: {
      ...
      expirationDateHelp: 'Selecione a data em que seu hedge expirará. Você pode escolher qualquer data de 3 dias a 1 ano no futuro. O hedge será automaticamente fechado nesta data.',
      days: 'dias',
