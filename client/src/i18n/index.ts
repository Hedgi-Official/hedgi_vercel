...
const ptBR = {
  translation: {
    ...
    companiesPage: {
      ...
      heroSubtitle: 'A Hedgi é a API de hedge cambial que se integra ao seu fluxo atual de payout/settlement (pagamento e liquidação). Feita para times que querem embutir hedge no produto ou proteger a exposição cambial interna.',
    ...
    aboutUs: {
      ...
      subheadline: 'A Hedgi ajuda indivíduos a travar taxas para transações futuras e ajuda empresas a incorporar proteção cambial em seus produtos e operações através de uma API simples e programável.',
      ...
      companies: 'Empresas',
      whatWeDoTitle: 'Um motor FX. Duas formas de usar.',
      cardATitle: 'Proteja um pagamento futuro em minutos',
      cardABody: 'Escolha um par de moedas, valor e prazo de proteção. A Hedgi mostra um custo estimado e ajuda você a travar o câmbio para o que vai pagar depois.',
      cardALink: 'Explorar Pessoas Físicas',
      cardBTitle: 'Incorpore proteção cambial com uma API',
      cardBBody: 'Ofereça taxas protegidas aos usuários ou proteja sua própria exposição cambial usando cotações, execução e fluxos programáticos.',
      cardBLink: 'Explorar Empresas',
      whyHedgiTitle: 'Por que pessoas e empresas escolhem a Hedgi',
      whyCard1Title: 'Simples por design',
      whyCard1Body: 'Sem configuração financeira pesada. Entradas claras, saídas claras e uma experiência construída em torno de pagamentos reais, não telas de trading.',
      whyCard2Title: 'Resultados previsíveis',
      whyCard2Body: 'O seguro cambial funciona como um bloqueio de orçamento: pague um custo conhecido para reduzir a incerteza das oscilações cambiais.',
      whyCard3Title: 'Feito para fluxos do mundo real',
      whyCard3Body: 'De mensalidades e viagens a faturas de fornecedores e plataformas cross-border, a Hedgi é projetada em torno de como o dinheiro realmente se move.',
      howItWorksTitle: 'Como funciona',
      howItWorksBody: 'Diga-nos o que você precisa proteger, escolha por quanto tempo, e a Hedgi cuida do resto.',
      step1Title: 'Defina a exposição',
      step1Helper: 'Par de moedas + valor + prazo',
      step2Title: 'Escolha o prazo de proteção',
      step2Helper: 'Dias, semanas ou meses, baseado em quando o pagamento acontece',
      step3Title: 'Fique protegido',
      step3Helper: 'Você obtém um resultado mais claro e previsível mesmo se o câmbio se mover',
