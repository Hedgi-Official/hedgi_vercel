  ...
  translation: {
    ...
    profile: {
      ...
      aboutUs: {
        ...
        '75% of companies not using currency protection lose money due to fluctuations. Currency moves erased $9.83 billion from corporate earnings in just one quarter.': '75% das empresas que não usam proteção cambial perdem dinheiro devido às flutuações. Movimentos cambiais apagaram US$ 9,83 bilhões dos lucros corporativos em apenas um trimestre.',
        'At <span className="font-semibold text-primary">Hedgi</span>, we provide simple currency insurance so you never lose money when buying from other countries - whether you\'re a business or an individual.': 'Na <span className="font-semibold text-primary">Hedgi</span>, oferecemos seguro cambial simples para que você nunca perca dinheiro ao comprar de outros países - seja você uma empresa ou um indivíduo.',
        'Protecting businesses since 2024': 'Protegendo empresas desde 2024',
        '75%': '75%',
        'Companies Lose Money': 'Empresas Perdem Dinheiro',
        '$9.8B': 'US$ 9,8 bi',
        'Lost to Currency Moves': 'Perdidos em Movimentos Cambiais',
        'Coverage Available': 'Cobertura Disponível',
        'Countries Supported': 'Países Suportados',
        'Built for Everyone': 'Feito para Todos',
        'Whether you\'re buying supplies for your business or shopping online from international stores, currency swings shouldn\'t eat into your budget. Our platform makes currency protection accessible for anyone who buys from other countries.': 'Seja você comprando suprimentos para sua empresa ou fazendo compras online em lojas internacionais, flutuações cambiais não devem consumir seu orçamento. Nossa plataforma torna a proteção cambial acessível para qualquer pessoa que compra de outros países.',
        ...
        'Simple Protection in 3 Steps': 'Proteção Simples em 3 Passos',
        'Plan Your Purchase': 'Planeje Sua Compra',
        'Tell us when and how much you plan to buy from another country. We\'ll show you the current exchange rate and protection cost.': 'Nos diga quando e quanto você planeja comprar de outro país. Mostraremos a taxa de câmbio atual e o custo da proteção.',
        'Get Protected': 'Obtenha Proteção',
        'Lock in today\'s exchange rate with our currency insurance. Pay a small premium to protect against unfavorable rate changes.': 'Fixe a taxa de câmbio de hoje com nosso seguro cambial. Pague um pequeno prêmio para se proteger contra mudanças desfavoráveis na taxa.',
        'Make Your Purchase': 'Faça Sua Compra',
        'Buy with confidence knowing your costs are locked. If rates move against you, we cover the difference automatically.': 'Compre com confiança sabendo que seus custos estão fixados. Se as taxas se moverem contra você, cobriremos a diferença automaticamente.',
        'Why Choose Hedgi': 'Por Que Escolher a Hedgi',
        'Enterprise Security': 'Segurança Empresarial',
        'Bank-grade encryption and security protocols protect your financial data and transactions.': 'Criptografia e protocolos de segurança de nível bancário protegem seus dados financeiros e transações.',
        'Real-time Rates': 'Taxas em Tempo Real',
        'Access live exchange rates from multiple financial institutions for accurate pricing.': 'Acesse taxas de câmbio ao vivo de várias instituições financeiras para precificação precisa.',
        'Professional Support': 'Suporte Profissional',
        'Expert guidance and 24/7 customer support to help with your currency protection needs.': 'Orientação especializada e suporte ao cliente 24/7 para ajudar com suas necessidades de proteção cambial.',
        'Global Reach': 'Alcance Global',
        'Protect against currency fluctuations for purchases from any country worldwide.': 'Proteja-se contra flutuações cambiais para compras de qualquer país do mundo.',
        'Ready to Protect Your Money?': 'Pronto para Proteger Seu Dinheiro?',
        'Join thousands of businesses and individuals who trust Hedgi to protect their international purchases from currency risk.': 'Junte-se a milhares de empresas e indivíduos que confiam na Hedgi para proteger suas compras internacionais do risco cambial.',
        'Start Protecting Today': 'Comece a se Proteger Hoje',
        'Contact Us': 'Entre em Contato',
        'Questions? Reach out to our team': 'Dúvidas? Entre em contato com nossa equipe',
