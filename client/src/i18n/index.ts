...
const enUS = {
  translation: {
    ...
    aboutUs: {
      ...
      cardBBody: 'Offer protected rates to users—or hedge your own FX exposure—using quotes, execution, and programmatic workflows designed for product teams.',
      ...
      whoWeAreBody: 'Hedgi is building currency protection that feels as simple as insurance—so individuals can plan ahead, and companies can ship protected experiences inside their products.',
      howToReachUsTitle: 'How to reach us',
      howToReachUsBody: 'Questions, partnerships, or press—reach our team anytime.',
      emailMain: 'hello@hedgi.ai',
      emailPartnerships: 'For API pilots and integrations:',
      emailPartnershipsAddress: 'partnerships@hedgi.ai',
...
const ptBR = {
  translation: {
    ...
    landing: {
      ...
      companies: 'Empresas',
      individualsHelper: 'Trave taxas para viagens, pagamentos de mensalidades, assinaturas ou grandes compras internacionais.',
      companiesHelper: 'Proteja sua própria exposição de tesouraria ou incorpore soluções de hedge cambial para seus clientes.',
    ...
    forIndividuals: {
      ...
      chip2Desc: 'Sem jargões, apenas valor + data',
      ...
      lifestyleSectionSubtitle: 'Hedge não é só para grandes empresas. Pessoas físicas usam para manter despesas reais previsíveis.',
      useCasesTitle: 'Motivos comuns pelos quais as pessoas usam o Hedgi',
      card1Title: 'Compradores Online',
      card1Desc: 'Quando você compra em outra moeda, o custo final pode mudar antes do seu cartão ser compensado. Trave uma janela de taxa para manter o total previsível.',
      card1Example: 'Compras internacionais, assinaturas, pré-vendas',
      card2Title: 'Viajantes',
      card2Desc: 'Defina um orçamento de viagem antecipadamente. Se a taxa de câmbio mudar, seu plano não precisa mudar. O Hedgi te dá tranquilidade para focar em aproveitar sua viagem.',
      card2Example: 'Hotéis, voos, pacotes de turismo, compras',
      card3Title: 'Estudantes no Exterior',
      card3Desc: 'Mensalidade e aluguel são fixos em moeda estrangeira, mas sua moeda local não é. Proteja o orçamento de cada semestre para universidade ou programas de intercâmbio.',
      card3Example: 'Mensalidade, moradia, seguro saúde, despesas de vida',
      card4Title: 'Trabalhadores Remotos',
      card4Desc: 'Recebe em USD ou EUR, mas tem seu custo de vida indexado a outra moeda? Reduza o risco de uma semana de conversão ruim antes de sacar.',
      card4Example: 'Trabalho remoto, consultoria, criadores e afiliados',
      howItWorksTitle: 'Como funciona',
      howItWorksSubtitle: 'Proteção cambial em três passos simples.',
      step1Title: 'Escolha o que você está protegendo',
      step1Desc: 'Escolha um par de moedas e valor que corresponda à sua próxima transação.',
      step2Title: 'Escolha um prazo',
      step2Desc: 'Escolha uma data de vencimento em dias ou semanas até um ano no futuro.',
      step3Title: 'Obtenha preços previsíveis',
      step3Desc: 'Veja o custo estimado do hedge e trave uma janela de taxa para esse período.',
      createAccount: 'Crie sua conta',
      tryItTitle: 'Experimente você mesmo',
      tryItSubtitle: 'Obtenha uma estimativa rápida, ou peça ao assistente para guiá-lo.',
      chatTitle: 'Assistente IA Hedgi',
      chatPrompt: 'Me diga o que você está pagando (viagem, mensalidade, fatura) e quando. Vou te ajudar a entender hedging e sugerir uma configuração simples.',
      chatPlaceholder: 'Estou pagando $3.000 em 30 dias...',
      chatWelcome: 'Me diga o que você está pagando (viagem, mensalidade, fatura) e quando. Vou te ajudar a entender hedging e sugerir uma configuração simples.',
    ...
    aboutUs: {
      ...
      cardABody: 'Escolha um par de moedas, valor e janela de tempo. O Hedgi mostra um custo estimado de proteção e ajuda você a travar uma taxa para o que vai pagar depois.',
      cardALink: 'Explorar Pessoas Físicas',
      cardBTitle: 'Incorpore proteção cambial com uma API',
      cardBBody: 'Ofereça taxas protegidas aos usuários—ou proteja sua própria exposição cambial—usando cotações, execução e fluxos programáticos projetados para equipes de produto.',
      cardBLink: 'Explorar Empresas',
      whyHedgiTitle: 'Por que pessoas e empresas escolhem o Hedgi',
      ...
      whyCard3Body: 'De mensalidades e viagens a faturas de fornecedores e plataformas cross-border—o Hedgi é projetado em torno de como o dinheiro realmente se move.',
      howItWorksTitle: 'Como funciona',
      howItWorksBody: 'Diga-nos o que você precisa proteger, escolha por quanto tempo, e o Hedgi cuida do resto.',
      step1Title: 'Defina a exposição',
      step1Helper: 'Par de moedas + valor + prazo',
      step2Title: 'Escolha a janela de proteção',
      ...
      whoWeAreBody: 'O Hedgi está construindo proteção cambial que parece tão simples quanto seguro—para que indivíduos possam planejar com antecedência, e empresas possam entregar experiências protegidas dentro de seus produtos.',
      howToReachUsTitle: 'Como nos encontrar',
      howToReachUsBody: 'Dúvidas, parcerias ou imprensa—entre em contato com nossa equipe a qualquer momento.',
      emailMain: 'hello@hedgi.ai',
      emailPartnerships: 'Para pilotos de API e integrações:',
      emailPartnershipsAddress: 'partnerships@hedgi.ai',
