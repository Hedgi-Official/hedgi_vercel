...
const enUS = {
  translation: {
    ...
    forIndividuals: {
      ...
      imageAlt: 'Happy customers using Hedgi'
    },
    footer: {
...
const ptBR = {
  translation: {
    ...
    forIndividuals: {
      ...
      heroSubtitle: 'Se você vai gastar, receber ou pagar em moeda estrangeira, as taxas de câmbio podem mudar seu custo total ou seus planos. A Hedgi ajuda você a torná-los previsíveis em minutos.',
      ...
      card1Desc: 'Quando você compra em outra moeda, o custo final pode mudar antes do seu cartão ser compensado. Trave o câmbio por um prazo para manter o total previsível.',
      card1Example: 'Compras internacionais, assinaturas, pré-vendas',
      card2Title: 'Viajantes',
      card2Desc: 'Defina um orçamento de viagem antecipadamente. Se a taxa de câmbio mudar, seu plano não precisa mudar. A Hedgi ajuda você a focar em aproveitar sua viagem.',
      ...
      step3Desc: 'Veja o custo estimado do hedge e trave o câmbio por esse período.',
      createAccount: 'Crie sua conta',
      tryItTitle: 'Experimente você mesmo',
      tryItSubtitle: 'Obtenha uma estimativa rápida ou peça para o assistente ajudar.',
      chatTitle: 'Assistente IA Hedgi',
      chatPrompt: 'Diga o que você está pagando (viagem, mensalidade, fatura) e quando. Vou ajudar você a entender hedging e sugerir uma configuração simples.',
      chatPlaceholder: 'Estou pagando $3.000 em 30 dias...',
      chatWelcome: 'Diga o que você está pagando (viagem, mensalidade, fatura) e quando. Vou ajudar você a entender hedging e sugerir uma configuração simples.',
      ...
      imageAlt: 'Clientes satisfeitos usando a Hedgi'
    },
    footer: {
