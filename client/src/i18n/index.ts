...
const enUS = {
  translation: {
    ...
    forIndividuals: {
      ...
      card1Example: 'International checkouts, subscriptions, pre-orders, and more.',
      ...
      card2Example: 'Hotels, flights, tourism packages, large shopping purchases',
      ...
      card4Example: 'Remote work, consulting, creator income and affiliate marketing',
      howItWorksTitle: 'How it works',
      howItWorksSubtitle: 'Currency protection in three simple steps.',
      step1Title: "Choose what you're protecting",
      step1Desc: 'Pick a currency pair and amount that matches your upcoming payment or income.',
      step2Title: 'Pick a timeframe',
      step2Desc: 'Choose an expiration date (days, weeks, or months).',
      ...
      chatPrompt: "Tell me what you're paying for (trip, tuition, invoice) and when. I'll suggest a simple hedge setup.",
      chatPlaceholder: "I'm paying $3,000 in 30 days...",
      chatWelcome: "Tell me what you're paying for (trip, tuition, invoice) and when. I'll suggest a simple hedge setup.",
...
const ptBR = {
  translation: {
    ...
    forIndividuals: {
      ...
      card1Example: 'Compras internacionais, assinaturas, pré-vendas e mais.',
      ...
      card2Example: 'Hotéis, voos, pacotes de turismo, grandes compras',
      ...
      card4Example: 'Trabalho remoto, consultoria, renda de criador e marketing de afiliados',
      howItWorksTitle: 'Como funciona',
      howItWorksSubtitle: 'Proteção cambial em três passos simples.',
      step1Title: 'Escolha o que você está protegendo',
      step1Desc: 'Escolha um par de moedas e valor que corresponda ao seu próximo pagamento ou recebimento.',
      step2Title: 'Escolha um prazo',
      step2Desc: 'Escolha uma data de vencimento (dias, semanas ou meses).',
      ...
      chatPrompt: 'Me diga o que você está pagando (viagem, mensalidade, fatura) e quando. Vou sugerir uma configuração de hedge simples.',
      chatPlaceholder: 'Estou pagando $3.000 em 30 dias...',
      chatWelcome: 'Me diga o que você está pagando (viagem, mensalidade, fatura) e quando. Vou sugerir uma configuração de hedge simples.',
