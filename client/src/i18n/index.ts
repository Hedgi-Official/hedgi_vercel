...
const enUS = {
  translation: {
    ...
    forIndividuals: {
      ...
      card2Desc: "Set a trip budget in advance. If the exchange rate moves, your plan doesn't have to.",
      card2Example: 'Hotels, flights, packages, big-ticket purchases',
      card3Title: 'Students Abroad',
      card3Desc: "Tuition and rent are fixed in a foreign currency—even if your home currency isn't. Protect a semester's budget.",
      card3Example: 'Tuition, housing, living expenses',
      card4Title: 'Freelancers',
      card4Desc: 'Getting paid in USD or EUR? Reduce the risk of a bad conversion week before you cash out.',
      card4Example: 'Remote work, consulting, creator income',
...
const ptBR = {
  translation: {
    ...
    forIndividuals: {
      ...
      card2Desc: 'Defina um orçamento de viagem antecipadamente. Se a taxa de câmbio mudar, seu plano não precisa mudar.',
      card2Example: 'Hotéis, voos, pacotes, compras grandes',
      card3Title: 'Estudantes no Exterior',
      card3Desc: 'Mensalidade e aluguel são fixos em moeda estrangeira—mesmo que sua moeda local não seja. Proteja o orçamento do semestre.',
      card3Example: 'Mensalidade, moradia, despesas de vida',
      card4Title: 'Freelancers',
      card4Desc: 'Recebe em USD ou EUR? Reduza o risco de uma semana de conversão ruim antes de sacar.',
      card4Example: 'Trabalho remoto, consultoria, renda de criador',
