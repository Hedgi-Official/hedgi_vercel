...
export function EnhancedCurrencySimulator({ showGraph = true, onPlaceHedge, onOrdersUpdated }: Props) {
  ...
  const handleSimulate = async () => {
    ...
    if (!currentRate || !swapValues) {
      console.error('[EnhancedCurrencySimulator] CRITICAL: Missing live broker data!', {
    ...
    console.log('[EnhancedCurrencySimulator] Using LIVE Flask server data:', {
    ...
    console.log('[EnhancedCurrencySimulator] FIXED CALCULATION BREAKDOWN:', {
